        ...
        <div className="about txt">
            ...
            <div className="bio">
                ...
                <div className="two txt">
                    In fact, that is how I discovered my strong passion in programming. On a whim, I took a "100 Days of Python" course on Udemy and became obssessed. I fell in love with the unusual combination of creativity and logic required to build projects and have been passionate about programming ever since. While I started coding with Python, I moved on to a focus on web development using the following technologies: JavaScript, HTML5, CSS, and React. 
                </div>
                {/* <img className="icon left" src="../../images/web-development.png"></img> */}
                <div className="third txt">
                    What I lack in experience, I make up with enthusiasm, determination, and persistence. Given the chance, I know I can help you achieve the website of your dreams. Not only that, but as a thanks for your trust I will build your website at no cost to you! Right now, building a positive reputation with potential clients is much more important to me than any monetary gain. Still not convinced? Feel free to shoot me message through my <a href="/contact">Contact Page</a> or feel free to send me an Email at thedev@thenathanielgonzalez.com! I would love the chance to speak with you.
                </div>
                <h2>Thank you!</h2>
            </div>
        </div>
